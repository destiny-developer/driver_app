// Copyright 2015 The Knowband Authors. All rights reserved.
...
class LayoutSizeChangeNotifier extends SingleChildRenderObjectWidget {
  ...
  const LayoutSizeChangeNotifier({Key? key, required Widget child}) : super(key: key, child: child);
...
class _SizeChangeRenderWithCallback extends RenderProxyBox {
  _SizeChangeRenderWithCallback({RenderBox? child, required this.onLayoutChangedCallback}) : super(child);
