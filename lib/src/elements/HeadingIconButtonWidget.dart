...
class HeadingIconButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Row(
        children: <Widget>[
          Expanded(child: Row(children: <Widget>[this.icon, SizedBox(width: 10), this.text])),
          IconButton(color: Theme.of(context).hintColor, onPressed: () {}, icon: Icon(Icons.more_horiz), iconSize: 28)
        ],
      ),
    );
  }
