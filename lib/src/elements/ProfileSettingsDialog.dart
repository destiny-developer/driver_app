...
class _ProfileSettingsDialogState extends State<ProfileSettingsDialog> {
            ...
            return SimpleDialog(
              ...
              title: Row(
                children: <Widget>[
                  Icon(Icons.person),
                  SizedBox(width: 10),
                  Text(S.of(context).profile_settings, style: Theme.of(context).textTheme.bodyLarge)
                ],
              ),
              children: <Widget>[
                Form(
                ...
                Row(
                  children: <Widget>[
                    MaterialButton(onPressed: () => Navigator.pop(context), child: Text(S.of(context).cancel)),
                    MaterialButton(onPressed: _submit, child: Text(S.of(context).save, style: TextStyle(color: Theme.of(context).shadowColor))),
                  ],
  ...
  InputDecoration getInputDecoration({required String hintText, required String labelText}) {
    return new InputDecoration(
      ...
      enabledBorder: UnderlineInputBorder(borderSide: BorderSide(color: Theme.of(context).hintColor.withValues(alpha: 0.2))),
