...
class EmptyNotificationsWidget extends StatefulWidget {
  EmptyNotificationsWidget({Key? key}) : super(key: key);
...
class _EmptyNotificationsWidgetState extends State<EmptyNotificationsWidget> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        loading
            ? SizedBox(height: 3, child: LinearProgressIndicator(backgroundColor: Theme.of(context).shadowColor.withValues(alpha: 0.2)))
            : SizedBox(),
        Container(
            ...
            children: <Widget>[
              Stack(
                children: <Widget>[
                  Container(
                    ...
                    child: Icon(Icons.notifications, color: Theme.of(context).scaffoldBackgroundColor, size: 70),
                  ),
                  Positioned(
                    right: -30,
                    bottom: -50,
              ...
              Opacity(
                ...
                child: Text(
                  ...
                  style: Theme.of(context).textTheme.displaySmall?.merge(TextStyle(fontWeight: FontWeight.w300)),
                ),
              ),
              SizedBox(height: 50),
              !loading
                  ? MaterialButton(
                      ...
                      child: Text(
                        'Go To Home',
                        style: Theme.of(context).textTheme.headlineSmall?.merge(TextStyle(color: Theme.of(context).scaffoldBackgroundColor)),
                      ),
                    )
                  : SizedBox(),
            ],
