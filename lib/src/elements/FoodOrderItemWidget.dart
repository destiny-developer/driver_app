...
class FoodOrderItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      onTap: () => Navigator.of(context).pushNamed('/OrderDetails', arguments: RouteArgument(id: order.id)),
      child: Container(
        padding: EdgeInsets.symmetric(horizontal: 20, vertical: 8),
        decoration: BoxDecoration(color: Theme.of(context).scaffoldBackgroundColor.withValues(alpha: 0.9)),
        child: Row(
