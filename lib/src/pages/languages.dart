  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        centerTitle: true,
        title: Text(S.of(context).languages, style: Theme.of(context).textTheme.headlineSmall?.merge(TextStyle(letterSpacing: 1.3))),
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: ListTile(
                ...
                leading: Icon(Icons.translate, color: Theme.of(context).hintColor),
                title: Text(
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                settingRepo.getDefaultLanguage(settingRepo.setting.value.mobileLanguage.value.languageCode).then((_langCode) {
                  if (_langCode == _language.code) _language.selected = true;
                });
                return InkWell(
                  onTap: () async {
                    settingRepo.setting.value.mobileLanguage.value = new Locale(_language.code!, '');
                    settingRepo.setting.notifyListeners();
                    languagesList!.languages.forEach((_l) => setState(() => _l.selected = false));
                        ...
                        Stack(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.all(Radius.circular(40)),
                                color: Theme.of(context).shadowColor.withValues(alpha: _language.selected ? 0.85 : 0),
                              ),
                              child: Icon(
                                Icons.check,
                                size: _language.selected ? 24 : 0,
                                color: Theme.of(context).primaryColor.withValues(alpha: _language.selected ? 0.85 : 0),
                              ),
                            ),
                          ],
                        ),
